...
const Partners = () => {
  ...
  return <div className="w-full min-h-screen bg-gradient-to-b from-white to-gray-50">
      {/* Hero Section */}
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {partners.map((partner, index) => <Card key={index} className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-white border-2 hover:border-hc-orange">
                <CardContent className="p-8 text-center">
                  ...
                  <Button asChild className="bg-hc-green hover:bg-hc-orange text-white w-full group-hover:scale-105 transition-transform">
      ...
      <section className="py-16 bg-gradient-to-r from-hc-green/10 to-hc-orange/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <Button asChild size="lg" className="bg-hc-orange hover:bg-hc-green text-white">
            <a href="/contact">
              Nous contacter
            </a>
          </Button>
